...
alias monitor="mons"
# Finding files
alias fa="fd --type f --hidden --exclude R --exclude x86_64-pc-linux-gnu-library --exclude go --exclude .TinyTex --exclude .local --exclude .config/google-chrome --exclude .opam --exclude .cargo --exclude .local/share --exclude .cache --exclude .local/pipx --exclude .git --exclude .npm --exclude .nvm --base-directory $HOME --search-path $HOME | fzf --print0 | xargs -0 -o nvim"
alias f="fd --type f --hidden --exclude R --exclude x86_64-pc-linux-gnu-library --exclude go --exclude .TinyTex --exclude .local --exclude .config/google-chrome --exclude .opam --exclude .cargo --exclude .local/share --exclude .cache --exclude .local/pipx --exclude .git --exclude .npm --exclude .nvm | fzf --print0 | xargs -0 -o nvim"
# GPU
